...
bool ScopeTable::insert(const string& name, const string& type, ofstream& out) {
...
bool ScopeTable::insert(const string& name, const string& type, bool is_declared, bool is_defined) {
...
bool SymbolTable::insert(const string& name, const string& type, bool is_declared, bool is_defined) {
    if (this->current_scope == nullptr) {
        return false;
    }
...
bool SymbolTable::insertInParentScope(const string& name, const string& type, bool is_declared, bool is_defined) {
    if (this->current_scope == nullptr || this->current_scope->get_parent_scope() == nullptr) {
        return false;
    }
    return this->current_scope->get_parent_scope()->insert(name, type, is_declared, is_defined);
}
