...
func_definition : type_specifier ID LPAREN parameter_list RPAREN compound_statement[true]
		| type_specifier ID LPAREN RPAREN compound_statement[true]
 		;				
...
compound_statement[bool isFunction] : LCURL statements RCURL
 		    | LCURL RCURL
 		    ;
